...
\section{Results}
The results show that to complete the same number of tasks Decentralized approach performs slower compared to centralized approach to cover same number of tasks. 
\begin{figure*}[!t]
\centering
\subfloat[1]{\includegraphics[width=0.25\textwidth,height=0.3\textheight]{/home/neelesh/Independent_study/images/figure_4.png}}
\subfloat[2]{\includegraphics[width=0.25\textwidth,height=0.3\textheight]{/home/neelesh/Independent_study/images/figure_3.png}}
\subfloat[3]{\includegraphics[width=0.25\textwidth,height=0.3\textheight]{/home/neelesh/Independent_study/images/figure_2.png}}
\subfloat[4]{\includegraphics[width=0.25\textwidth,height=0.3\textheight]{/home/neelesh/Independent_study/images/figure_1.png}}
\caption{Centralized Approach, traversability graph of tasks and sequence of suggested tasks for T = 5}
\label{fig_sim}
\subfloat[1]{\includegraphics[width=0.25\textwidth,height=0.3\textheight]{/home/neelesh/Independent_study/images/de_figure_2.png}}
\hfil
\subfloat[2]{\includegraphics[width=0.25\textwidth,height=0.3\textheight]{/home/neelesh/Independent_study/images/de_figure_1.png}}
\subfloat[3]{\includegraphics[width=0.25\textwidth,height=0.3\textheight]{/home/neelesh/Independent_study/images/de_figure_3.png}}
\subfloat[4]{\includegraphics[width=0.25\textwidth,height=0.3\textheight]{/home/neelesh/Independent_study/images/de_figure_4.png}}
\caption{Decentralized Approach, traversability graph of tasks and sequence of suggested tasks for T = 5}
\label{fig_sim1}

\subfloat[1]{\includegraphics[width=0.25\textwidth]{/home/neelesh/Independent_study/images/result1.png}}
\hfil
\subfloat[2]{\includegraphics[width=0.25\textwidth]{/home/neelesh/Independent_study/images/result2.png}}
\subfloat[3]{\includegraphics[width=0.25\textwidth]{/home/neelesh/Independent_study/images/result3.png}}
\subfloat[4]{\includegraphics[width=0.25\textwidth]{/home/neelesh/Independent_study/images/result4.png}}
\caption{Results obtained for centralized and decentralized approaches}
\label{fig_sim2}
\end{figure*}
